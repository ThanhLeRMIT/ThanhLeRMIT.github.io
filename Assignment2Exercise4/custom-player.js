...
/* function for muting audio that we went over in class. Felt this was relevant to an audio piece.*/
...
/* function to allow audio to loop when the end of the track is reached, felt this was appropriate since its listed as music to relax/study to. 
   used ❌ and ⭕ icons to give feedback on whether the loop was running, chosen for simplicity as well as stylistically fitting in  with the 🔊 
   on the opposite side of the timer bar.*/
